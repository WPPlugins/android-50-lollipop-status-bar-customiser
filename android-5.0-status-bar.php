...
class WN_Android_50_Statusbar
{
  ...
  public function add_android_meta()
  {
    ...
    if ( isset( $this->options['vibrate'] ) && $this->options['vibrate'] == 1 ) {
      $output .= <<<HTML
<script type="text/javascript">
navigator.vibrate = navigator.vibrate || navigator.webkitVibrate || navigator.mozVibrate || navigator.msVibrate;
// vibrate for 500ms if available
...
HTML;
  ...
  {        
    ...
    add_settings_section(
      'misc', // ID
      'Misc Settings', // Title
      array( $this, 'print_section_info_misc' ), // Callback
      'wn-android-statusbar' // Page
    );
    
    add_settings_field(
      'vibrate', // ID
      'Enable Vibration (if available)', // Title 
      array( $this, 'vibrate_callback' ), // Callback
      'wn-android-statusbar', // Page
      'misc', // Section     
      array( 'id' => 'vibrate' )
    );
   ...
   * Print the Section text for Icons
   */
  public function print_section_info_misc()
  {
    echo 'Configure misc settings here.';
  }
